...
public final class ContextIDs {
    ...
    public static final Identifier CHUNK_MESH = Identifier.fromNamespaceAndPath("mbp", "chunk_mesh");
    public static final Identifier ENTITY = Identifier.fromNamespaceAndPath("mbp", "entity");
}
